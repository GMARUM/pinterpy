...
#                     del plevelsinterpolatedfieldU.attrs['coordinates']
#                     plevelsinterpolatedfieldU.attrs['projection'] = str(plevelsinterpolatedfieldU.projection)
#                     plevelsinterpolatedfieldU.to_netcdf(ncoutputfileU+'-'+str(timestamp), mode='w') 
#                     ncoutputfileV = ncoutputfile.replace('.nc','') + '-V.nc'
#                     del plevelsinterpolatedfieldV.attrs['coordinates']
#                     plevelsinterpolatedfieldV.attrs['projection'] = str(plevelsinterpolatedfieldV.projection)
#                     plevelsinterpolatedfieldV.to_netcdf(ncoutputfileV+'-'+str(timestamp), mode='w')
#                     ncoutputfileMOD = ncoutputfile.replace('.nc','') + '-MOD.nc'
#                     plevelsinterpolatedfieldMOD.to_netcdf(ncoutputfileMOD+'-'+str(timestamp), mode='w')     
#                else:
#                     del plevelsinterpolatedfield.attrs['coordinates']
#                     plevelsinterpolatedfield.attrs['projection'] = str(plevelsinterpolatedfield.projection)
#                     plevelsinterpolatedfield.to_netcdf(ncoutputfile+'-'+str(timestamp), mode='w') 
...
#                        del plevelsinterpolatedfieldU.attrs['coordinates']
#                        plevelsinterpolatedfieldU.attrs['projection'] = str(plevelsinterpolatedfieldU.projection)
#                        plevelsinterpolatedfieldU.to_netcdf(ncoutputfileU+'-'+str(timestamp), mode='a') 
#                        ncoutputfileV = ncoutputfile.replace('.nc','') + '-V.nc'
#                        del plevelsinterpolatedfieldV.attrs['coordinates']
#                        plevelsinterpolatedfieldV.attrs['projection'] = str(plevelsinterpolatedfieldV.projection)
#                        plevelsinterpolatedfieldV.to_netcdf(ncoutputfileV+'-'+str(timestamp), mode='a')
#                        ncoutputfileMOD = ncoutputfile.replace('.nc','') + '-MOD.nc'
#                        plevelsinterpolatedfieldMOD.to_netcdf(ncoutputfileMOD+'-'+str(timestamp), mode='a')     
#                    else:
#                        del plevelsinterpolatedfield.attrs['coordinates']
#                        plevelsinterpolatedfield.attrs['projection'] = str(plevelsinterpolatedfield.projection)
#                        plevelsinterpolatedfield.to_netcdf(ncoutputfile+'-'+str(timestamp), mode='a') 
